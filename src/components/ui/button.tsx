  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        primary: "bg-primary text-primary-foreground hover:bg-primary-hover hover:scale-[1.02]",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary-hover hover:scale-[1.02]",
        accent: "bg-accent text-accent-foreground hover:bg-accent-hover hover:scale-[1.02]",
        success: "bg-success text-success-foreground hover:bg-success-hover hover:scale-[1.02]",
        special: "bg-special text-special-foreground hover:opacity-90 hover:scale-[1.02]",
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90 hover:scale-[1.02]",
        outline: "border border-input bg-transparent hover:bg-accent hover:text-accent-foreground hover:scale-[1.02]",
